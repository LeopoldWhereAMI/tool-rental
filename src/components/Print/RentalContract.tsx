    ...
    <article className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.flexBetween}>
          <h1 className={styles.title}>Договор № {orderData.order_number}</h1>
        </div>
        <div className={styles.flexBetween}>
      ...
      <section className={styles.section}>
        ...
        <p className={`${styles.textIndent} ${styles.underline}`}>
          {orderData.last_name} {orderData.first_name} {orderData.middle_name},
        </p>
        <p className={styles.textIndent}>
      ...
      <section className={styles.section}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              ...
              <td>{orderData.end_date}</td>
              <td>{inventory.daily_price} руб./сутки</td>
        ...
        <p>
          ...
          <strong>{inventory.purchase_price} руб.</strong> (
          <strong>
            {priceToWords(Number(inventory.purchase_price))} рублей 00 копеек
          </strong>
          )
        </p>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          <strong>{inventory.daily_price} руб./сутки</strong> в соответствии с
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          действует до «{hours}» часов «{minutes}» минут, « {orderData.end_date}{" "}
          ». Окончание срока действия договора не влечет прекращения
      ...
      <section className={styles.aktSection}>
        ...
        <div>
          <span>
            Клиент: ____________ / {orderData.last_name} {orderData.first_name}
          </span>
