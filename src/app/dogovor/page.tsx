    ...
    <article className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.flexBetween}>
          <h1 className={styles.title}>Договор № _________</h1>
        </div>
        <div className={styles.flexBetween}>
          <span>г. Железногорск</span>
          <span>«___» часов «___» минут « ___ » __________202__ г.</span>
        </div>
      </header>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.textIndent}>
          ...
          ___________ № ____________________ выдан:
          __________________________________________________________________________________,
          когда _________________ зарегистрирован по адресу:
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          ___________ руб. ( ________________________________ )
        </p>
        <ul className={styles.list}>
          ...
          <li>
            ...
            ответственность за вред, причиненный третьим лицам и их имуществу с
            помощью Имущества Пункта проката.
          </li>
          <li>
            1.6. Имущество передается Клиенту и возвращается в Пункт проката по
            адресу: г. Железногорск Курская область , ул. Мира 6 А – Мастерская
            № 1.
          </li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          2.1. За прокат Имущества Клиент уплачивает сумму в размере
          _______________________________________________ руб./сутки/сумма (
          прописью ) в соответствии с прейскурантом цен на услуги.
        </p>
        <p>
        ...
        <p>
          2.4. Оплата производится наличными денежными средствами в кассу Пункта
          проката, либо платежным безналичным перечислением на расчетный счет
          Пункта проката не позднее 3 (трёх) рабочих дней с момента возврата
          Имущества.
        </p>
        <p>
        ...
        <p>
          ...
          Обеспечительный платеж в размере ___________ руб. (
          ________________________________ )
        </p>
        <p>
          2.7. Обеспечительный платеж не является задатком в значении, данном
          этому термину в статьях 380, 381 Гражданского кодекса РФ. Проценты на
          сумму Обеспечительного платежа не начисляются.
        </p>
        <p>
        ...
        <p>
          ...
          Клиентом или третьими лицами в период проката Имущества и на покрытие
          сумм задолженности Клиента перед Пунктом проката, включая неустойку,
          предусмотренную п. 5.1, 5.2, 4.2.4 договора.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          действует до «___» часов «___» минут, « ___ » __________ 202__г.
          Окончание срока действия договора не влечет прекращения обязательств
          по оплате.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          правилами предоставления Имущества в прокат, эксплуатации и стоимостью
          проката Имущества.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            правилами его эксплуатации и техническими характеристиками; следить
            за целостностью и сохранностью, не допуская замены деталей и
            вскрытия;
          </li>
          <li>
          ...
          <li>
            ...
            каждые 5 суток. Запрещается использовать собственную бензосмесь для
            2х-тактных двигателей. Нарушив данный пункт, Клиент берет на себя
            обязательства по ремонту вне зависимости от причин поломки;
          </li>
          <li>
            4.2.6. Клиент обязан вернуть Имущество в пригодном для эксплуатации
            состоянии, в чистом виде. В противном случае взимается плата за
            чистку в размере 500 руб. за единицу.
          </li>
        </ul>
      </section>
      ...
      <section className={styles.grid}>
        ...
        <div>
          <h3>Клиент:</h3>
          <p>Ф.И.О. _____________________________________</p>
          <p>Паспорт Серия _________ № ________________,</p>
          <p>Дата Выдачи: _______________________________</p>
          <p>Кем Выдан: _________________________________</p>
          <p>Адрес регистрации: _________________________</p>
          <div>
      ...
      <section className={styles.aktSection}>
        <h2>АКТ ПРИЕМА-ПЕРЕДАЧИ ИМУЩЕСТВА В ПРОКАТ</h2>
        <p>
          1. Во исполнение условий Договора № ________ от «___» ________
          202___г., Пункт проката передал, а Клиент принял во временное владение
        ...
        <p>
          3. Клиент обязуется оплатить неисправности якоря, статора, двигателя,
          редуктора и иных повреждений в соответствии с п.4.2.2 Договора.
        </p>
        <div>
          <span>Клиент: ____________ / ___________</span>
